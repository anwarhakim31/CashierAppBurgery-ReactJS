...
const AuthLayout = (props) => {
  ...
  return (
    <div className=" max-w-sreen  min-h-screen flex justify-center items-center font-inter">
      <div className="card w-full   sm:max-w-[420px] min-h-screen   xs:block  sm:min-h-fit shadow-md shadow-slate-800 bg-gradient-to-b from-white via-white to-blue-600 py-2 px-4 xs:p-8 bg-slate-200 rounded-none md:rounded-lg">
